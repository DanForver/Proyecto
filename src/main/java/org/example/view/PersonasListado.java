 ...
 * @author Admin
 */
public class PersonasListado extends javax.swing.JFrame {

    /**
     * Creates new form PersonasListado
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonasListado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
